...
public class CreditXmlEmploymentDetails {
	...
	public String toString() {
		return "CreditXmlEmploymentDetails{" + "status='" + status + '\'' + ", employer='" + employer + '\''
				+ ", jobTitle='" + jobTitle + '\'' + ", monthlyNetIncome=" + monthlyNetIncome + '}';
	}
}
